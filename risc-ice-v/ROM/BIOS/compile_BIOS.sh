...
$ARCH-elf-gcc -fno-unroll-loops -O1 -fno-pic -march=rv32imc -mabi=ilp32 -S c/BIOSlibrary.c -o build/libBIOS.s
$ARCH-elf-gcc -fno-unroll-loops -O1 -fno-pic -march=rv32imc -mabi=ilp32 -c -o build/libBIOS.o c/BIOSlibrary.c
