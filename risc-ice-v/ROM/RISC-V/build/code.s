...
.L306:
	lui	s1,%hi(.LANCHOR1)
	lui	a5,%hi(.LANCHOR1+24)
	addi	s2,a5,%lo(.LANCHOR1+24)
...
.L378:
	lui	a5,%hi(ufo_bullet_number)
	lbu	s2,%lo(ufo_bullet_number)(a5)
	li	a5,255
	bne	s2,a5,.L330
	lui	a5,%hi(ufo_sprite_number)
	lbu	a4,%lo(ufo_sprite_number)(a5)
...
.L352:
	...
	sb	s2,%lo(ufo_bullet_direction)(a4)
.L335:
