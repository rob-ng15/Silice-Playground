...
gpu_quadrilateral:
	...
	mv	a2,a5
	sw	a7,12(sp)
	lui	s11,%hi(GPU_COLOUR)
	lw	a5,%lo(GPU_COLOUR)(s11)
	sb	a0,0(a5)
	lui	s10,%hi(GPU_X)
	lw	a5,%lo(GPU_X)(s10)
	sh	a1,0(a5)
	...
	lw	a5,%lo(GPU_Y)(s9)
	sh	s0,0(a5)
	lui	s8,%hi(GPU_PARAM0)
	lw	a5,%lo(GPU_PARAM0)(s8)
	sh	a3,0(a5)
	lui	s7,%hi(GPU_PARAM1)
	lw	a5,%lo(GPU_PARAM1)(s7)
	sh	a4,0(a5)
	lui	s6,%hi(GPU_PARAM2)
	lw	a5,%lo(GPU_PARAM2)(s6)
	sw	a2,4(sp)
	sh	a2,0(a5)
	lui	s5,%hi(GPU_PARAM3)
	lw	a5,%lo(GPU_PARAM3)(s5)
	sw	a6,8(sp)
	sh	a6,0(a5)
	call	wait_gpu
	lui	s4,%hi(GPU_WRITE)
	lw	a5,%lo(GPU_WRITE)(s4)
	li	s3,7
	sb	s3,0(a5)
	lw	a5,%lo(GPU_COLOUR)(s11)
	sb	s2,0(a5)
