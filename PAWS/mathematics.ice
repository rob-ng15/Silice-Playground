...
algorithm aluIb001(
    ...
    input   uint32  SHFLoutput,
    input   uint1   SHFLbusy,
...
algorithm aluIb101(
    ...
    input   uint32  UNSHFLoutput,
    input   uint1   UNSHFLbusy,
    input   uint32  GREVoutput,
    input   uint1   GREVbusy,
    input   uint32  GORCoutput,
    input   uint1   GORCbusy,
