...
unsigned char volatile * LOWER_TM_BACKGROUND = (unsigned char volatile *) 0x820c;
unsigned char volatile * LOWER_TM_FOREGROUND = (unsigned char volatile *) 0x8210;
unsigned char volatile * LOWER_TM_COMMIT = (unsigned char volatile *) 0x8214;
unsigned char volatile * LOWER_TM_WRITER_TILE_NUMBER = (unsigned char volatile *) 0x8220;
unsigned char volatile * LOWER_TM_WRITER_LINE_NUMBER = (unsigned char volatile *) 0x8224;
unsigned short volatile * LOWER_TM_WRITER_BITMAP = (unsigned short volatile *) 0x8228;
unsigned char volatile * LOWER_TM_SCROLLWRAPCLEAR = (unsigned char volatile *) 0x8230;
unsigned char volatile * LOWER_TM_STATUS = (unsigned char volatile *) 0x8234;

unsigned char volatile * UPPER_TM_X = (unsigned char volatile *) 0x8280;
unsigned char volatile * UPPER_TM_Y = (unsigned char volatile *) 0x8284;
unsigned char volatile * UPPER_TM_TILE = (unsigned char volatile *) 0x8288;
unsigned char volatile * UPPER_TM_BACKGROUND = (unsigned char volatile *) 0x828c;
unsigned char volatile * UPPER_TM_FOREGROUND = (unsigned char volatile *) 0x8290;
unsigned char volatile * UPPER_TM_COMMIT = (unsigned char volatile *) 0x8294;
unsigned char volatile * UPPER_TM_WRITER_TILE_NUMBER = (unsigned char volatile *) 0x82a0;
unsigned char volatile * UPPER_TM_WRITER_LINE_NUMBER = (unsigned char volatile *) 0x82a4;
unsigned short volatile * UPPER_TM_WRITER_BITMAP = (unsigned short volatile *) 0x82a8;
unsigned char volatile * UPPER_TM_SCROLLWRAPCLEAR = (unsigned char volatile *) 0x82b0;
unsigned char volatile * UPPER_TM_STATUS = (unsigned char volatile *) 0x82b4;
