...
int main( void ) {
    ...
    while(1) {
        ...
        copper_startstop( 0 );
        copper_program( 0, COPPER_WAIT_Y, 7, 0, BKG_SNOW, DKBLUE - 1, WHITE );
        copper_program( 1, COPPER_WAIT_X, 7, 0, BKG_SNOW, DKBLUE - 1, WHITE );
        ...
        copper_program( 11, COPPER_WAIT_X, 7, 0, BKG_SNOW, BLACK, BLUE );
