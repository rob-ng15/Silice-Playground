...
$ARCH-elf-gcc -ffunction-sections -fdata-sections -O3 -I/usr/riscv32-elf/include/ -march=rv32imac -mabi=ilp32 -c -o build/libPAWS.o c/PAWSlibrary.c
$AR -cvq build/libPAWS.a build/libPAWS.o
$ARCH-elf-gcc -ffunction-sections -fdata-sections -O3 -I/usr/riscv32-elf/include/ -march=rv32imac -mabi=ilp32 -c -o build/code.o $1
