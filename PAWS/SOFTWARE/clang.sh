...
CFLAGS="--target=riscv32 -ffunction-sections -fdata-sections -Ofast -fno-builtin -fno-pic -fno-unroll-loops  -menable-experimental-extensions -march=rv32imacb0p92 -mabi=ilp32"
