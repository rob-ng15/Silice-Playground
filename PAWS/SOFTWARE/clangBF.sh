...
CFLAGS="--target=riscv32 -ffunction-sections -fdata-sections -O2 -fno-builtin -fno-pic -fno-unroll-loops -menable-experimental-extensions -march=rv32imafcb0p92 -mabi=ilp32f"
