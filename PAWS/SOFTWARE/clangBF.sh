...
CFLAGS="--target=riscv32 -ffunction-sections -fdata-sections -Os -fno-builtin -fno-pic -fno-unroll-loops -menable-experimental-extensions -march=rv32imafcb0p93 -mabi=ilp32f"
