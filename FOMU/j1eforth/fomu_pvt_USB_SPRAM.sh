...
yosys -D PVT=1 -p 'synth_ice40 -top top -json build.json' \
...
nextpnr-ice40 --up5k --freq 12 --opt-timing --package uwg30 --pcf pcf/fomu-pvt.pcf --json build.json --asc build.asc
