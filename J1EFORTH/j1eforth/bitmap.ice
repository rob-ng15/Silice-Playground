...
$$end
    ...
    while(1) {
        if( ~bitmap_A.rdata0 ) {
            pix_red = colourexpand2to$color_depth$[ bitmap_R.rdata0 ];
            pix_green = colourexpand2to$color_depth$[ bitmap_G.rdata0 ];
            pix_blue = colourexpand2to$color_depth$[ bitmap_B.rdata0 ];
            bitmap_display = 1;
        } else {
            bitmap_display = 0;
        }
