...
algorithm main(
    ...
    background background_generator <@clock,!video_reset>
    (
        pix_x      <: pix_x,
        pix_y      <: pix_y,
        pix_active <: active,
    ...
    gpu gpu_processor <@clock,!video_reset>
    (
    ...
    bitmap bitmap_window <@clock,!video_reset>
    (
        pix_x      <: pix_x,
        pix_y      <: pix_y,
        pix_active <: active,
    ...
    character_map character_map_window <@clock,!video_reset>
    (
        pix_x      <: pix_x,
        pix_y      <: pix_y,
        pix_active <: active,
    ...
    terminal terminal_window <@clock,!video_reset>
    (
        pix_x      <: pix_x,
        pix_y      <: pix_y,
        pix_active <: active,
    ...
    multiplex_display display <@clock,!video_reset>
    (
        pix_x      <: pix_x,
        pix_y      <: pix_y,
        pix_active <: active,
